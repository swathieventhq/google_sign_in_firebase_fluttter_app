...
import '../user/demo_user.dart';
import 'package:google_sign_in_firebase_fluttter_app/authenticated/components/add_comment_box.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Comments'),//backgroundColor: Colors.black,
     ),
      body: Column(
        children: [
          Expanded(
